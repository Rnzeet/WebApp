...
const HomeScreen = () => {
  ...
  return (
    ...
    {showTed1Image && <img src={ted1} alt="Teddy Bear" className="ted1-image" />}
    {showImage && <img src={teddyGif} alt="Teddy Bear" style={{ width: '200px', height: '200px',alignContent:'center',borderRadius:10
     }}/>}
        {showTedImage && <img src={ted} alt="Teddy Bear" className="ted-image" />}
    ...
    {showFullScreenGif && (
        <div className="full-screen-gif-overlay" onClick={handleCloseFullScreen}>
          <img src={crack} alt="Teddy Bear"  className="full-screen-gif" />
        </div>
      )}
  </div>
  );
